...
begin
  new JsonDocument(new JsonDeserializer(aFile.Path).Deserialize as JsonObject)
end;
...
begin
  ...
  new JsonDocument(new JsonDeserializer(new String(aBinary.ToArray, aEncoding)).Deserialize as JsonObject);
end;

class method JsonDocument.FromString(aString: String): JsonDocument;
begin
  new JsonDocument(new JsonDeserializer(aString).Deserialize as JsonObject)
end;
