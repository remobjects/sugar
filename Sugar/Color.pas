...
{$IF ECHOES}
class method Color.colorWithRGBAPercentage(aRed: Single; aGreen: Single; aBlue: Single; aAlpha: Single): System.Drawing.Color;
begin
  result := System.Drawing.Color.FromArgb(aAlpha*256 as Int32, aRed*256 as Int32, aGreen*256 as Int32, aBlue*256 as Int32);
end;

class method Color.colorWithRGBA256(aRed: Byte; aGreen: Byte; aBlue: Byte; aAlpha: Byte): System.Drawing.Color;
begin
  result := System.Drawing.Color.FromArgb(aAlpha, aRed, aGreen, aBlue);
end;
